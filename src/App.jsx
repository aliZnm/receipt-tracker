  ...
  return(
    ...
    <div className="app-root">
        ...
        {activePage === "passwordRecovery" && (
          <PasswordRecovery onBack={() => setActivePage(null)} />
        )}
          ...
          <div className="dashboard">
            <section className="dashboard-main">
              <div className="dashboard-text">
                <h1>Your Receipts</h1>
                <p>Track, organize, and search your purchase history in one place.</p>
              </div>
              ...
              <div className="receipt-grid">
                ...
                {receipts.map((receipt) => (
                  <div className="receipt-card" key={receipt.id} onClick={() => setViewingReceipt(receipt)} style={{cursor: "pointer", position: "relative"}}>
                    ...
                    <p className="receipt-subtext">Tap to view receipt</p>
                  </div>
                ))}
              </div>
            </section>
